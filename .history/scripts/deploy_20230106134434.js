...
async function main() {
    ...
    const walletModule = await walletModuleContract.deploy(
        '0x86E56a6E86e8C578E15EB47CcFD3823e1Da91E55',
        '0x76003bb652Aa84c97ddBacCe39Fef9d73F3C1146',
        '0xFbCa1ee2B84FbedBFC3C196EA19c5E3A8459EB8a',
        '0x104B694753602feE309A7fAC709E1FfB5167114F',
        '0x4ce2fa503105dE0010c6FcedB92Fd7B807789DC6',
        SECURITY_PERIOD,
        SECURITY_WINDOW,
        LOCK_PERIOD,
        RECOVERY_PERIOD);
