...
contract TransferStorage is ITransferStorage {
    ...
    function setWhitelist(address _wallet, address _target, uint256 _value) external override {
        whitelist[_wallet][_target] = _value;
    }

    function getWhitelist(address _wallet, address _target) external view override returns (uint256) {
