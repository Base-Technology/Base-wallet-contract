...
class RelayManager {
  ...
  async relay(_module, _method, _params, _wallet, _signers,
    ...
    const TestSimpleOracleContract = await ethers.getContractFactory("TestSimpleOracle");
    ...
    if (_refundToken !== ETH_TOKEN) {
      gasPrice = (await (await TestSimpleOracleContract.attach(this.priceOracle)).ethToToken(_refundToken, _gasPrice)).toNumber();
    }
